  ...
  return (
    <Box sx={{ mt: 4 }}>
      <Table sx={{ background: "#222", color: "#fff", borderRadius: 2 }}>
        <TableHead>
          <TableRow>
            <TableCell sx={{ color: "#e5f110ff" }}>Short URL</TableCell>
            <TableCell sx={{ color: "#e5f110ff" }}>Created</TableCell>
            <TableCell sx={{ color: "#e5f110ff" }}>Expires</TableCell>
            <TableCell sx={{ color: "#e5f110ff" }}>Clicks</TableCell>
            <TableCell sx={{ color: "#e5f110ff" }}>Click Details</TableCell>
          </TableRow>
        </TableHead>
        <TableBody>
